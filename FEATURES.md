...
- **Ecosystem inventory** — `research/forks/ecosystem-inventory.json` + `/demos/ecosystem-catalog` + generated [ECOSYSTEM-COLLECTION.md](research/forks/ECOSYSTEM-COLLECTION.md) (`bun run ecosystem:intake`, optional `bun run ecosystem:clone-upstream`); see [research/forks/README.md](research/forks/README.md) and [INTEGRATION-BACKLOG.md](research/forks/INTEGRATION-BACKLOG.md).
