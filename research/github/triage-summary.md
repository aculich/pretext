...
Generated: 2026-04-23T04:36:53.162Z
...
| [#29](https://github.com/chenglou/pretext/pull/29) | 88 | low | 2 | fix: align trailing collapsible space handling across all line-break paths |
...
| #157 | open | 60 | open, perf-ish | React Native: bridge native text measurement for virtualized lists |
...
|---:|:---|:---:|:---:|---|---:|:---|:---|
| #80 | open | no | 92 | low | 1 | — | docs: link to community awesome-pretext list |
| #132 | open | no | 88 | low | 2 | — | fix: prevent rich inline CJK fragments from overflowing maxWidth |
| #29 | open | no | 88 | low | 2 | — | fix: align trailing collapsible space handling across all line-break paths |
| #119 | open | no | 84 | low | 1 | — | perf: skip no-op merge passes in analysis pipeline |
...
| #97 | open | no | 70 | low | 2 | — | Add real-world examples and performance benchmarks |
| #41 | open | no | 70 | low | 1 | true | Updated |
| #20 | open | no | 70 | low | 2 | — | Fix lineCount inconsistency between layout() and layoutWithLines() |
| #5 | open | no | 70 | low | 1 | — | Document layout/algorithm technique in README.md |
| #140 | open | no | 58 | low | 3 | — | Perf/streaming layout optimizations |
| #126 | open | no | 58 | low | 3 | true | feat: add SSR support via setMeasureContext |
| #81 | open | no | 58 | low | 1 | — | Docs/quickstart usage guide |
| #72 | open | no | 58 | low | 4 | — | feat: add measurement host config entrypoint |
| #71 | open | no | 58 | medium | 6 | — | feat: add a compat entrypoint for portable regex support |
| #45 | open | no | 58 | low | 4 | — | Add intrinsic sizing APIs: minContentWidth and maxContentWidth |
| #37 | open | no | 58 | low | 4 | — | Add vertical Japanese layout support |
| #23 | open | no | 58 | low | 5 | — | Add French language support to editorial demos |
| #21 | open | no | 58 | low | 2 | — | Add usage guide with practical examples and integration patterns |
| #17 | open | no | 58 | low | 3 | true | feat: add `setMeasureFunction` for custom measurement backends |
| #16 | open | no | 58 | low | 6 | — | feat: add MCP server for AI-assisted text measurement |
| #3 | open | no | 58 | low | 7 | — | Fix bidi surrogate handling, ctx.font caching, emoji correction, and cleanup |
...
| #93 | open | no | 52 | medium | 3 | — | feat(demos): Floating Languages — multilingual physics demo with live reflow |
| #79 | open | no | 52 | medium | 4 | true | feat: add CJK line-breaking demo |
| #46 | open | no | 52 | medium | 4 | — | Add virtual chat demo with side-by-side DOM-layout comparison |
| #32 | open | no | 52 | medium | 5 | — | added server-side canvas support & Created Masonry Demo |
| #31 | open | no | 52 | low | 3 | — | demo: virtual scroll with zero DOM measurement |
| #19 | open | no | 52 | medium | 4 | — | Add editorial reflow demo with drop cap and pull quote |
...
| #139 | open | no | 45 | low | 1 | false | docs: document breakableFitAdvances cache invariant |
| #105 | open | no | 41 | low | 2 | false | fix: currency symbols stick to adjacent numbers during line breaking |
| #109 | open | no | 38 | high | 16 | — | feat: resolve rem/em font units to px before canvas measurement |
| #156 | closed | no | 35 | medium | — | — | feat: letterSpacing option via Canvas native API |
...
| #108 | closed | no | 35 | medium | — | — | feat: letterSpacing option in prepare() |
...
| #112 | open | yes | 13 | low | 3 | — | Add optional Playwright Chrome correctness driver |
| #35 | closed | yes | 12 | medium | — | — | docs: clarify prepare() vs layout() performance expectations |
| #149 | open | no | 11 | low | 1 | false | test: add direct coverage for documented public APIs |
| #138 | open | no | 11 | low | 2 | false | simplify: unify stepRichInlineLine/Stats and remove containsCJKText wrapper |
| #124 | open | no | 11 | low | 3 | false | Improve Korean keep-all mixed-script breaks |
| #90 | open | no | 11 | low | 4 | false | Add source span mapping to rich layout APIs |
