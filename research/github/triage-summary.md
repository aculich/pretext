...
Generated: 2026-04-12T12:18:40.710Z

## Wave 1 (recommended safe PRs)

| PR | Score | Risk | Files | Title |
|---:|---:|:---|---:|:---|
| [#125](https://github.com/chenglou/pretext/pull/125) | 92 | low | 1 | docs: fix unclosed parenthesis in walkLineRanges description |
...
| [#114](https://github.com/chenglou/pretext/pull/114) | 70 | low | 1 | Use localhost for Windows start script |
| [#97](https://github.com/chenglou/pretext/pull/97) | 70 | low | 2 | Add real-world examples and performance benchmarks |
...
| #121 | open | 73 | open, bug-ish, docs-ish | Bug: `layoutNextLine` and `walkLineRanges` mismatch with `layoutWithLines` |
| #91 | open | 73 | open, bug-ish, docs-ish | Improve Pretext docs/examples for hyphenation with user-generated text |
...
| #28 | open | 65 | open, bug-ish | Error message "Intl.Segmenter is not a constructor" |
...
| #86 | open | 58 | open, docs-ish | Questions |
| #70 | open | 58 | open, docs-ish | REQUEST: render an HTML string (rich text) which contains tags like h1, h2, or table |
| #36 | open | 58 | open, docs-ish | Agent skill for Pretext — helps AI coding agents use the library correctly |

## PRs (all, ranked)

| # | State | Draft | Score | Risk | Files | Mergeable | Title |
|---:|:---|:---:|:---:|---|---:|:---|:---|
| #125 | open | no | 92 | low | 1 | true | docs: fix unclosed parenthesis in walkLineRanges description |
...
| #113 | open | no | 52 | medium | 6 | true | demo: add Knuth-Plass optimal line-breaking with fitness classification |
...
| #30 | open | no | 45 | low | 1 | false | docs: add browser requirements section to README |
...
| #38 | open | no | 25 | medium | 5 | false | perf: complete V8 optimization suite (Phase 1-3: line-break, analysis, bidi) |
| #62 | open | no | 23 | low | 1 | false | Fix undefined variable in README example code |
...
| #37 | open | no | 11 | low | 4 | false | Add vertical Japanese layout support |
