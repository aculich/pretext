...
| Artifact | Purpose |
|----------|---------|
| [ecosystem-inventory.json](ecosystem-inventory.json) | All catalogued GitHub repos: source, `category` / `tags` / `summary` from awesome `app.js`, `demoUrl`, description, **stars / forks / pushedAt**, **relevance** + rationale, discovery extras. |
