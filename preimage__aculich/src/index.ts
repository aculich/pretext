...
// Adaptive-overlay luminance / contrast helpers (preimage__aculich fork).
// Re-exported here as the headline addition over upstream
// @somnai-dreams/preimage. Subpath import `@aculich/preimage/luminance` is
// also published for callers that only want this slice.
export {
  luminanceMapFromRgba,
  ...
  type LuminanceCell,
  type LuminanceMap,
  type LuminanceMapOptions,
  type NormRect,
  type RegionSample,
  type TextStyleSuggestion,
  type PackedLuminanceMap,
} from './luminance.js'
